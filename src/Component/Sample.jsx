...
const Sample = () => { 
  ...
  return (
    <div className=" bg-midnight py-10">
       ...
       {show&& <div className=" w-[90%]  xl:w-[70%] 2xl:w-[50%] text-xl mt-40">
          <div>
            <h1 className=" mb-20 text-5xl sm:text-6xl font-bold font-Black ">Terms and Conditions</h1>
            <h4 className=" text-3xl font-bold mb-5">The Legals </h4>
